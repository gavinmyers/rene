...
namespace Rene.CustomControl
{
    ...
    public class AdvancedRichTextBox : RichTextBox
    {
        ...
        public static readonly DependencyProperty DocumentProperty = DependencyProperty.Register("Document",
            ...
            typeof(FlowDocument), typeof(AdvancedRichTextBox));



        /// <summary>

        /// Initializes a new instance of the <see cref="AdvancedRichTextBox"/> class.
        ...
        /// <param title="document">A <see cref="T:System.Windows.Documents.FlowDocument"></see> to be added as the initial contents of the new <see cref="T:System.Windows.Controls.AdvancedRichTextBox"></see>.</param>

        public AdvancedRichTextBox(FlowDocument document)
        ...
        protected override void OnInitialized(EventArgs e)
        {
            ...
            DependencyPropertyDescriptor descriptor = DependencyPropertyDescriptor.FromProperty(DocumentProperty, typeof(AdvancedRichTextBox));
            ...
            this.LostFocus += new RoutedEventHandler(AdvancedRichTextBox_LostFocus);
        ...
        /// Handles the LostFocus event of the AdvancedRichTextBox control.
        ...
        void AdvancedRichTextBox_LostFocus(object sender, RoutedEventArgs e)
        {
        ...
        /// Gets or sets the <see cref="T:System.Windows.Documents.FlowDocument"></see> that represents the contents of the <see cref="T:System.Windows.Controls.AdvancedRichTextBox"></see>.

        /// </summary>

        /// <value></value>

        /// <returns>A <see cref="T:System.Windows.Documents.FlowDocument"></see> object that represents the contents of the <see cref="T:System.Windows.Controls.AdvancedRichTextBox"></see>.By default, this property is set to an empty <see cref="T:System.Windows.Documents.FlowDocument"></see>.  Specifically, the empty <see cref="T:System.Windows.Documents.FlowDocument"></see> contains a single <see cref="T:System.Windows.Documents.Paragraph"></see>, which contains a single <see cref="T:System.Windows.Documents.Run"></see> which contains no text.</returns>
